...
class _RegisterScreenState extends State<RegisterScreen> {
  ...
  void dispose() {
    ...
    _passCtrl.dispose(); _flatCtrl.dispose();
    super.dispose();
  }
              ...
              child: Form(
                ...
                child: Column(
                  ...
                  children: [
                    ...
                    _Field(controller: _nameCtrl, hint: 'e.g. Rahul Mehta',
                    ...
                    _Label('Password'),
                    const SizedBox(height: 8),
                    _Field(controller: _passCtrl, hint: 'Min. 6 characters',
                    ...
                    if (_role == 'RESIDENT') ...[
                      ...
                      _Field(
                        ...
                        validator: (v) => (v == null || v.trim().isEmpty)
                            ? 'Flat number is required for residents' : null,
                      ),
                    ],
...
class _Field extends StatelessWidget {
  ...
  const _Field({
    ...
    this.obscure = false, this.suffix, this.inputFormatters, this.validator,
  });
  ...
  Widget build(BuildContext context) {
    return TextFormField(
      ...
      textCapitalization: textCapitalization, obscureText: obscure,
  ...
  OutlineInputBorder _ob(BorderSide s) =>
      OutlineInputBorder(borderRadius: BorderRadius.circular(12), borderSide: s);
}
...
class _ErrorBanner extends StatelessWidget {
  ...
  Widget build(BuildContext context) => Container(
    ...
    decoration: BoxDecoration(
      color: _error.withOpacity(0.08), borderRadius: BorderRadius.circular(10),
      border: Border.all(color: _error.withOpacity(0.3)),
    ),
    child: Row(children: [
      const Icon(Icons.error_outline, color: _error, size: 18),
      const SizedBox(width: 8),
      Expanded(child: Text(message, style: const TextStyle(color: _error, fontSize: 13))),
    ]),
  );
}
